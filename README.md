# Evaluaciones DRO client php

Evaluación que analiza los ejes clave del Respeto Organizacional: Responsabilidad, Confianza, respeto por la organización y el respeto personal.
...
*/
    public function testDRO()
    {
        ...
        try {
            $result = $this->apiInstance->getDRO($x_api_key, $cve_usuario, $password,$cve_empresa, $body);
            $this->signer->close();
            print_r($result);
        } catch (Exception $e) {
            echo 'Exception when calling ConjuntoDeEvaluacionesApi->getDRO: ', $e->getMessage(), PHP_EOL;
        }
    }
```
## Pruebas unitarias
